    ...
    return(
        <div>
            ...
            {/* <form onSubmit={onSubmit}> */}
                ...
                <p>전시 종류:
                    <div>
                    <FormControlLabel value="정기전" control={<CheckBox color="primary"/>} label="정기전" labelPlacement="end"/>
                    <FormControlLabel value="신인전" control={<CheckBox color="primary"/>} label="신인전" labelPlacement="end"/>
                    <FormControlLabel value="주제" control={<CheckBox color="primary"/>} label="주제" labelPlacement="end"/>
                    </div>
                {/* <label>
                    <input type="checkbox" value={update.format || ''} className="format"  name="format"onChange={onChange}/>
                    정기전
                    </label> */}
                </p>
                <p>
